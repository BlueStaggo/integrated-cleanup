...
public abstract class ServerPlayerEntityMixin extends PlayerEntity {
	...
	@Redirect(
		...
		at = @At(
			value = "INVOKE",
			target = "Lnet/minecraft/entity/living/player/PlayerEntity;damage(Lnet/minecraft/entity/damage/DamageSource;I)Z"
		)
	)
	public boolean damageUpdateKnockbackYaw(PlayerEntity instance, DamageSource source, int amount) {
